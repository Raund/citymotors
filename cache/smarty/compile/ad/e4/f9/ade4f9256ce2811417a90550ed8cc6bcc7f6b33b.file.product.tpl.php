<?php /* Smarty version Smarty-3.1.19, created on 2018-04-03 00:39:34
         compiled from "/home/citymoto/citymotors.com.ua/www/themes/default-bootstrap/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:4114212745ac2a31615ec26-59206781%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ade4f9256ce2811417a90550ed8cc6bcc7f6b33b' => 
    array (
      0 => '/home/citymoto/citymotors.com.ua/www/themes/default-bootstrap/product.tpl',
      1 => 1468358880,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4114212745ac2a31615ec26-59206781',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ac2a31683cfe3_61166666',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ac2a31683cfe3_61166666')) {function content_5ac2a31683cfe3_61166666($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/citymoto/citymotors.com.ua/www/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home/citymoto/citymotors.com.ua/www/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/home/citymoto/citymotors.com.ua/www/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home/citymoto/citymotors.com.ua/www/tools/smarty/plugins/function.counter.php';
?>
...
<div itemscope itemtype="http://schema.org/Product">
	<div class="primary_block row" class="clearfix b1c-good">
...
" name="resetImages">
		...
		<div class="pb-center-column col-xs-12 col-sm-4">
			...
			<p id="product_reference"<?php if (empty($_smarty_tpl->tpl_vars['product']->value->reference)||!$_smarty_tpl->tpl_vars['product']->value->reference) {?> style="display: none;"<?php }?>>
				<label><?php echo smartyTranslate(array('s'=>'Артикул '),$_smarty_tpl);?>
 </label>
				<span class="editable" itemprop="sku" data-bme="Артикул товара"><?php if (!isset($_smarty_tpl->tpl_vars['groups']->value)) {?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->reference, ENT_QUOTES, 'UTF-8', true);?>
<?php }?></span>
			</p>
			<?php if ($_smarty_tpl->tpl_vars['product']->value->condition) {?>
			<p id="product_condition">
				<label><?php echo smartyTranslate(array('s'=>'Состояние'),$_smarty_tpl);?>
 </label>
							...
							<div class="price">
								<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
									...
									<?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?>
										<span id="our_price_display" itemprop="price" data-bme="Цена за штуку"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['productPrice']->value),$_smarty_tpl);?>
</span>
...
?>
									<?php if (count($_smarty_tpl->tpl_vars['group']->value['attributes'])) {?>
										<fieldset class="attribute_fieldset">
                                            <label class="b1c-caption" for="group_<?php echo intval($_smarty_tpl->tpl_vars['id_attribute_group']->value);?>
 ...
 :</label>
											...
											<div class="attribute_list">
												<?php if (($_smarty_tpl->tpl_vars['group']->value['group_type']=='select')) {?>
                                                    <select class="b1c-option" name="<?php echo $_smarty_tpl->tpl_vars['groupName']->value;?>
