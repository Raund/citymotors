...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5b6b0646a6fbc9_62352014',
  'has_nocache_code' => false,
  'cache_lifetime' => 31536000,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5b6b0646a6fbc9_62352014')) {function content_5b6b0646a6fbc9_62352014($_smarty_tpl) {?><div id="search_block_left"><form method="get" action="http://citymotors.loc/search" id="searchbox"> <input type="hidden" name="orderby" value="position" /> <input type="hidden" name="controller" value="search" /> <input type="hidden" name="orderway" value="desc" /> <input type="text" id="search_query_block" placeholder="поиск по каталогу" name="search_query" value="" /> <button type="submit" id="search_button"><i class="fa fa-search"></i></button></form></div><?php }} ?>
