	...
	<div class="primary_block row" class="clearfix b1c-good">
		...
		<div class="pb-center-column col-xs-12 col-sm-4">
			...
			<p id="product_reference"{if empty($product->reference) || !$product->reference} style="display: none;"{/if}>
				...
				<span class="editable" itemprop="sku" data-bme="Артикул товара">{if !isset($groups)}{$product->reference|escape:'html':'UTF-8'}{/if}</span>
			</p>
			{if $product->condition}
			<p id="product_condition">
				<label>{l s='Состояние'} </label>
							...
							<div class="price">
								<p class="our_price_display" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
									...
									{if $priceDisplay >= 0 && $priceDisplay <= 2}
										<span id="our_price_display" itemprop="price" data-bme="Цена за штуку">{convertPrice price=$productPrice}</span>
