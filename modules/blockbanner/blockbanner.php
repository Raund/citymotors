...
*  International Registered Trademark & Property of PrestaShop SA displayLeftColumn
*/
			...
			'form' => array(
				...
				'input' => array(
					array(
						...
						'desc' => $this->l('Upload an image for your top banner. The recommended dimensions are 270 x 390px if you are using the default theme.'),
						'lang' => true,
					),
					array(
						'type' => 'text',
