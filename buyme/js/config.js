...
// checkbox: ?Вопрос
	...
	"fields": "Ваше имя и фамилию(Укажите имя и фамилию), Телефон (Номер телефона)*, !Способ оплаты!Наложенный!На карту Приват*, -Адрес доставки(Укажите город и номер отделения службы доставки)*",
